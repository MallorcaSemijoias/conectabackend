...
app.post("/", (req, res) => {
    ...
    const resposta = parametro + randomLink;

    // Aqui você pode adicionar a lógica relacionada à rota POST conforme necessário
    res.send(resposta);

    // Agora, para a rota GET, você pode usar o mesmo valor de "resposta"
    app.get(`/${resposta}`, (parametro, res) => {
        res.send(`
        <!DOCTYPE html>
        <html lang="pt-br">
